...
class CustomArmorItem extends Armor{
	...
	public function __construct(string $name, CustomItemProperties $properties){
		...
		parent::__construct(new ItemIdentifier($this->properties->getTypeId(), $this->properties->getId(), $this->properties->getMeta()), $this->properties->getName(), new ArmorTypeInfo(
